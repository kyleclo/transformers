...
def train(args, train_dataset, model: PreTrainedModel, tokenizer: PreTrainedTokenizer) -> Tuple[int, float]:
    ...
    true_effective_batch_size = args.train_batch_size * args.gradient_accumulation_steps * num_gpus
    logger.info(f"""
       ...
       Since our dataset has N = {len(train_dataset)} instances in total, 
       and we want to perform {args.max_steps} gradient updates,
       we'll need to make (approx) {args.num_train_epochs} epochs through the entire dataset.
       
       We will actually perform {t_total} updates.
    """)
...
def main():
    ...
    # define some custom stuff
    args.warmup_steps = int(args.warmup_pct * args.max_steps)
